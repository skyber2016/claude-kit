...
| Need | Read |
| ---- | ---- |
| DESIGN.md format / tokens | `~/.claude/plugins/marketplaces/claude-kit-marketplace/skills/design-spec/SKILL.md` |

---

| Task         | Read                            |
| ------------ | ------------------------------- |
| Web UI/UX    | `~/.claude/plugins/marketplaces/claude-kit-marketplace/agents/frontend-specialist.md` |
| Mobile UI/UX | `~/.claude/plugins/marketplaces/claude-kit-marketplace/agents/mobile-developer.md`    |
